...
% FAQ alapján mikor érdemes konstruktort/SetUp-ot használni, majd jöhet a minta kód
% 
...
% ugyanazokat a vektorokat hoztam létre többször a különböző tesztekhez: ezt eliminálni kellene (fixture, setup, teardown)
