...
\begin{frame}
 ...
 \end{itemize}
 \vfill
 Részletesen megvizsgáljuk: \hiv{\href{https://google.github.io/googletest/}{googletest}}
\end{frame}

\section{googletest}

\subsection{Az első teszprogram elkészítése}
\input{section0301.tex}

\subsection{Lebegőpontos számok kezelése}
\input{section0302.tex}

\subsection{Operátor felültöltés}
\input{section0303.tex}

\subsection{Kimenet és karakterláncok kezelése}
\input{section0304.tex}

\subsection{Fixtures}
\input{section0305.tex}

\subsection{Parancssori kapcsolók}
\input{section0306.tex}

\subsection{Kivételek és haláltesztek}
\input{section0307.tex}

\subsection{Qt Creator integráció}
\input{section0308.tex}

\section[Forr.]{Források}

\begin{frame}
  Tesztelésről általában\\
  \hiv{\href{https://dtk.tankonyvtar.hu/bitstream/handle/123456789/13039/0046_szoftverteszteles.pdf?sequence=2&isAllowed=y}%
